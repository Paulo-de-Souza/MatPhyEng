...
def coeff_muscl(convw,convs,vis2d,phi2d,prand):
...
# conpute inlet fluc
      ...
      if earsm:
         ...
         if scheme == 'm':
             aw2d,ae2d,as2d,an2d,su2d_local =coeff_muscl(convw,convs,vis2d,u2d,1)
...
# boundary conditions for v2d
      ...
      if scheme == 'm':
         aw2d,ae2d,as2d,an2d,su2d_local =coeff_muscl(convw,convs,vis2d,v2d,1)
         su2d=su2d+su2d_local
      if maxit > 0:
...
# coefficients
         ...
         if earsm:
            ...
            if scheme == 'm':
                aw2d,ae2d,as2d,an2d,su2d_local =coeff_muscl(convw,convs,vis2d,k2d,prand_k)
                su2d=su2d+su2d_local
            else:
...
# boundary conditions for om2d
         if earsm:
            ...
            if scheme == 'm':
                aw2d,ae2d,as2d,an2d,su2d_local =coeff_muscl(convw,convs,vis2d,om2d,prand_omega)
                su2d=su2d+su2d_local
            else:
...
# boundary conditions for eps2d
         if scheme == 'm':
            aw2d,ae2d,as2d,an2d,su2d_local =coeff_muscl(convw,convs,vis2d,eps2d,prand_eps)
            su2d=su2d+su2d_local
         else:
